...
export class RecipeBusiness {
    ...
    public createRecipe = async (input: any) => {
        ...
        if (typeof title !== "string") {
            ...
            throw new Error("Parâmentro titlhe deve ser uma string");
        ...
        const response = {
            message: "Receita criada com sucesso", recipe
        }
    ...
    public editRecipe = async (input: any) => {
        ...
        if (description && description.length< 10){
            throw new Error("Praametro description deve possuir pelo menos 10 caracteres");
        ...
        const response = {
            message: "Receita editada com sucesso", recipe
        }
